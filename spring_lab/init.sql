...
(
    account_num character varying(20) NOT NULL primary key,
...
(
    car_id character varying(20) NOT NULL primary key,
...
(
    ...
    birthday date,
    account_num character varying(20) references Bank(account_num),
    car_id character varying(20) references Car(car_id),
